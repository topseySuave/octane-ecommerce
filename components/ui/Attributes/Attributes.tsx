    ...
    <>
      <div className="oct-attributes">
        ...
        <Radio.Group defaultValue="a" buttonStyle="outline">
          <Radio.Button className="oct-radio-button" value="1" style={{ backgroundColor: '#F62F5E' }} />
          <Radio.Button className="oct-radio-button" value="2" style={{ backgroundColor: '#6EB2FB' }} />
          <Radio.Button className="oct-radio-button" value="3" style={{ backgroundColor: '#00D3CA' }} />
          <Radio.Button className="oct-radio-button" value="4" style={{ backgroundColor: '#FE5C07' }} />
          <Radio.Button className="oct-radio-button" value="5" style={{ backgroundColor: '#F8E71C' }} />
          <Radio.Button className="oct-radio-button" value="6" style={{ backgroundColor: '#7ED321' }} />
          <Radio.Button className="oct-radio-button" value="7" style={{ backgroundColor: '#9013FE' }} />
        </Radio.Group>
      </div>
      <div className="oct-attributes">
