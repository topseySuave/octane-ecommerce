# Next.js TypeScript Starter [![CircleCI](https://circleci.com/gh/deptno/next.js-typescript-starter-kit.svg?style=svg)](https://circleci.com/gh/deptno/next.js-typescript-starter-kit)
...
```sh
git clone https://github.com/topseySuave/next-typescript-starter.git my-project
cd my-project
rm -r .git
yarn
```
...
- styled-jsx/css [issue#2](https://github.com/topseySuave/next-typescript-starter/issues/2)
- external css, module [issue#3](https://github.com/topseySuave/next-typescript-starter/issues/3)
